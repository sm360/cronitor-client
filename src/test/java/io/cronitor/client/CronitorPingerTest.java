...
public class CronitorPingerTest {
    ...
    public void shouldPingAgainAfterTimeout() throws Exception {
        // connect to a port that will timeout
        pinger.setURL(true, command, code, apiKey, message, true);
